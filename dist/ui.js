...
var loadingDOM = null;
var spinner = null;
var loadingStyle = 'z-index:3000;position:fixed;left:0;top:0;height:100%;width:100%;background:rgba(255,255,255,0.3);display:flex;justify-content:center;align-items:center;user-select:none;';
var hideStyle = 'display:none;';
var spinnerBaseStyle = 'transition: all 100s linear;font-size:30px;color:rgba(0,0,0,0.5)';
var spinnerAdd = 'transition: all 100s linear;font-size:30px;color:rgba(0,0,0,0.5);transform: rotate(18000deg);';
...
var toastContainerStyle = 'z-index:3001;position:fixed;top:20px;left:50%;transform:translate(-50%,0);background:white;overflow:hidden;filter:drop-shadow(0 0 10px rgba(0,0,0,0.2));border-radius:5px;';
var toastContentStyle = 'position:absolute;top:0;left:0;overflow:hidden;display:flex;justify-content:center;align-items:center;background:white;' + toastSize;
